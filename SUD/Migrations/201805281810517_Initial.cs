namespace SUD.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            //            Cost = c.Decimal(nullable: false, precision: 18, scale: 2),
            //            Quantity = c.Single(nullable: false),
            //            KardexId = c.Long(nullable: false),
        ...
        public override void Down()
        {
            ...
            //DropForeignKey("dbo.tbl_Orders", "State_StateId", "dbo.States");
            //DropForeignKey("dbo.tbl_Shipments", "State_StateId", "dbo.States");
            ...
            //DropForeignKey("dbo.PurchaseDetails", "Product_ProductId", "dbo.tbl_Products");
            //DropForeignKey("dbo.PurchaseDetails", "Kardex_KardexId", "dbo.Kardexes");
            //DropForeignKey("dbo.PurchaseDetailBks", "Product_ProductId", "dbo.tbl_Products");
            //DropForeignKey("dbo.PurchaseDetailBks", "Kardex_KardexId", "dbo.Kardexes");
            ...
            //DropIndex("dbo.States", "State_Description_Index");
            //DropIndex("dbo.Purchases", new[] { "StateId" });
            //DropIndex("dbo.Purchases", new[] { "CellarId" });
            //DropIndex("dbo.Purchases", new[] { "SupplierId" });
            //DropIndex("dbo.PurchaseDetails", new[] { "Product_ProductId" });
            //DropIndex("dbo.PurchaseDetails", new[] { "Kardex_KardexId" });
            ...
            //DropIndex("dbo.PurchaseDetailBks", new[] { "Product_ProductId" });
            //DropIndex("dbo.PurchaseDetailBks", new[] { "Kardex_KardexId" });
            ...
            //DropTable("dbo.PurchaseDetailBks");
